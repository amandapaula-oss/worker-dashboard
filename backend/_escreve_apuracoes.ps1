...
$mapa = @(
  @{ orig = "Health\Apuração Meta 2026 Health OFICIAL.xlsx";      novo = "Health\Apuração Meta 2026 Health - 18.09.xlsx";      bu = "BU_Health" }
  @{ orig = "Finance\Apuração Meta Finance (AE) OFICIAL.xlsx";    novo = "Finance\Apuração Meta Finance (AE) - 18.09.xlsx";    bu = "BU_Finance" }
  @{ orig = "Grupo Mult\Apuração Meta Grupo Mult Oficial.xlsx";   novo = "Grupo Mult\Apuração Meta Grupo Mult - 18.09.xlsx";   bu = "BU_Logistics" }
  @{ orig = "Multisector\Apuração Meta Multisector OFICIAL V3.xlsx"; novo = "Multisector\Apuração Meta Multisector - 18.09.xlsx"; bu = "BU_Multisector" }
  @{ orig = "Retail\Apuração Meta Retail  (AE) OFICIAL.xlsx";     novo = "Retail\Apuração Meta Retail (AE) - 18.09.xlsx";      bu = "BU_Retail" }
)
...
try {
  foreach ($m in $mapa) {
    ...
    $xl.Calculation = -4135   # manual enquanto escreve (so vale com pasta aberta)
