"""
Exporta base completa Q4 Health:
...
def main():
    ...
    print(f"OK: {output}")
    print(f"  Projetos Q4 Health  : {len(sheet1)} linhas | {sheet1['pep'].nunique()} PEPs | {sheet1['nome_cliente'].nunique()} clientes")
